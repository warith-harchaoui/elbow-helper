...
``research/multiknee/RESULTS.md`` and ``MATH-en.md`` for the derivation and the
...
``MATH-en.md`` section 5 for why that difference is deliberate.
...
def dp_optimal_partition(
    ...
    See ``MATH-en.md`` section 7 for the recursion and complexity, and
