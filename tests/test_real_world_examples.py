...
figures and prose in ELBOW-en.tex: the k-means inertia elbow and
...
# needed instead; see ELBOW-en.tex for this trade-off.
...
def pca_scree_curve(
    ...
    eigenvalues never actually take. Shared with ELBOW-en.tex's
    PCA figure.
    """
    rng = np.random.default_rng(seed)
...
def test_pca_scree_elbow_detects_true_signal_dimension():
    ...
    for seed in range(5):
        ...
        # not exactly on it; see ELBOW-en.tex for this reading.
